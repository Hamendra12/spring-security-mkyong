...
Database authentication, using Spring-JDBC and MySQL. Spring Security, JSP TagLib, sec:authorize access="hasRole('ROLE_USER') Customize a 403 access denied page.
...
Note:: Username “mkyong”, with role_user and role_admin. Username “alexa”, with role_user.
